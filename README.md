...
Use reponsive units for text, images and buttons. Use semantic tags so that users who rely on screen readers can navigate accordingly. Use a visual graphic with colorful components so that users are not soley dependent on understanding the information based on color.
